...
/*
Например, создание различных типов документов (PDF, Word) в зависимости от пользовательского выбора.
...
3. Для создания объекта не нужно знать его конкретный тип.
